...
func update_property():
	pass
	#self.propertynames = String(self.properties)
	#var propertyNames : String
	#for n in self.properties:
		#if self.properties != null:
			#propertyNames = propertyNames + n.tilename
	#return propertyNames
	
	#var propertyNames : String
	#if self.properties != null:
		#for i in range (self.properties.size()):
			#var property = self.properties[i]
			#propertyNames = propertyNames + self.property.tilename
