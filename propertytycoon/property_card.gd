...
@onready var property_lbl: Label = $PropertyDisplay/HBoxContainer/VBoxContainer/PropertyLabel
@onready var cost_lbl: Label = $PropertyDisplay/HBoxContainer/VBoxContainer/PropertyCost
